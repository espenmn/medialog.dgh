...
#
#  $ bin/test -s medialog.dgh -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src medialog.dgh.testing.MEDIALOG_DGH_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/medialog/dgh/tests/robot/test_example.robot
#
